...
sku_sup_aggregated_data AS (
  SELECT DISTINCT
    ...
    CASE
      WHEN ad.tier_thresholdtype = 'Absolute' AND ad.calculated_against IS NULL THEN
      ...
      WHEN ad.tier_thresholdtype = 'Percentage' AND ad.calculated_against IS NULL THEN
        CASE WHEN ad.term_frequency = 'Monthly' THEN ad.sum_net_amount_current_month_sup_term - ad.sum_net_amount_prev_month_sup_term
             WHEN ad.term_frequency = 'Quarterly' THEN ad.sum_net_amount_current_quarter_sup_term - ad.sum_net_amount_prev_year_quarter_sup_term
             WHEN ad.term_frequency IN ('One time', 'Annually') THEN ad.sum_net_amount_current_year_sup_term - ad.sum_net_amount_prev_year_sup_term END
      WHEN ad.tier_thresholdtype = 'Absolute' AND ad.calculated_against = 'Same Period Last Year' THEN
        CASE WHEN ad.term_frequency = 'Monthly' THEN ad.sum_net_amount_current_month_sup_term - ad.sum_net_amount_prev_year_month_sup_term
             WHEN ad.term_frequency = 'Quarterly' THEN ad.sum_net_amount_current_quarter_sup_term - ad.sum_net_amount_prev_year_quarter_sup_term
             WHEN ad.term_frequency IN ('One time', 'Annually') THEN ad.sum_net_amount_current_year_sup_term - ad.sum_net_amount_prev_year_sup_term END
      WHEN ad.tier_thresholdtype = 'Percentage' AND ad.calculated_against = 'Same Period Last Year' THEN
        CASE WHEN ad.term_frequency = 'Monthly' THEN SAFE_DIVIDE(ad.sum_net_amount_current_month_sup_term, ad.sum_net_amount_prev_year_month_sup_term)
             WHEN ad.term_frequency = 'Quarterly' THEN SAFE_DIVIDE(ad.sum_net_amount_current_quarter_sup_term, ad.sum_net_amount_prev_year_quarter_sup_term)
             WHEN ad.term_frequency IN ('One time', 'Annually') THEN SAFE_DIVIDE(ad.sum_net_amount_current_year_sup_term, ad.sum_net_amount_prev_year_sup_term) END
      WHEN ad.tier_thresholdtype = 'Absolute' AND ad.calculated_against = 'Previous Period' THEN
        CASE WHEN ad.term_frequency = 'Monthly' THEN ad.sum_net_amount_current_month_sup_term - ad.sum_net_amount_prev_month_sup_term
             WHEN ad.term_frequency = 'Quarterly' THEN ad.sum_net_amount_current_quarter_sup_term - ad.sum_net_amount_prev_quarter_sup_term
             WHEN ad.term_frequency IN ('One time', 'Annually') THEN ad.sum_net_amount_current_year_sup_term - ad.sum_net_amount_prev_year_sup_term END
      WHEN ad.tier_thresholdtype = 'Percentage' AND ad.calculated_against = 'Previous Period' THEN
        CASE WHEN ad.term_frequency = 'Monthly' THEN SAFE_DIVIDE(ad.sum_net_amount_current_month_sup_term, ad.sum_net_amount_prev_month_sup_term)
             WHEN ad.term_frequency = 'Quarterly' THEN SAFE_DIVIDE(ad.sum_net_amount_current_quarter_sup_term, ad.sum_net_amount_prev_quarter_sup_term)
             WHEN ad.term_frequency IN ('One time', 'Annually') THEN SAFE_DIVIDE(ad.sum_net_amount_current_year_sup_term, ad.sum_net_amount_prev_year_sup_term) END
...
sup_aggregated_data AS (
  ...
  ORDER BY
    CASE WHEN suad.tier_thresholdtype = 'Absolute' THEN
      GREATEST(0,
        CASE
          WHEN suad.term_frequency = 'Monthly' THEN suad.sum_net_amount_current_month_sup_term - suad.tier_term_threshold
          WHEN suad.term_frequency = 'Quarterly' THEN suad.sum_net_amount_current_quarter_sup_term - suad.tier_term_threshold
          WHEN suad.term_frequency IN ('One time', 'Annually') THEN suad.sum_net_amount_current_year_sup_term - suad.tier_term_threshold
        END
      )
        WHEN suad.tier_thresholdtype = 'Percentage' THEN
       GREATEST(0, 
         CASE WHEN suad.term_frequency = 'Monthly' THEN suad.sum_net_amount_current_month_sup_term - suad.sum_net_amount_prev_month_sup_term
           WHEN suad.term_frequency = 'Quarterly' THEN suad.sum_net_amount_current_quarter_sup_term - suad.sum_net_amount_prev_year_quarter_sup_term
           WHEN suad.term_frequency IN ('One time', 'Annually') THEN suad.sum_net_amount_current_year_sup_term - suad.sum_net_amount_prev_year_sup_term
       END
     )
    END 
) as rn
